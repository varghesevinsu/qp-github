...
export class AppHomePageBaseComponent {
    ...
    tileWidth: any = "20%"
    displayMenus = false;
    constructor(public bs: AppHomeBaseService, public utilBase: AppUtilBaseService, public _sanitize: DomSanitizer) { }
    onInit(): void {
    ...
    getSanitizedContent(label:string){
        return this._sanitize.bypassSecurityTrustHtml(label);
      }
